...
var MinimumLengthLimit = function MinimumLengthLimit(limit) {
  return {
    ...
    match: true,
    message: "\uCD5C\uC18C ".concat(limit, "\uAE00\uC790 \uC774\uC0C1 \uC774\uC5B4\uC57C \uD569\uB2C8\uB2E4.")
  };
};
...
var AddressField = /*#__PURE__*/function () {
  function AddressField(container, data) {
    ...
    this.render = function () {
      ...
      if (append) {
        ...
        divFragment.innerHTML = _this.template(Object.assign({}, _this.data));
        container.appendChild(divFragment.firstElementChild);
      } else {
        container.innerHTML = _this.template(Object.assign({}, _this.data));
      }
...
var TextField = /*#__PURE__*/function () {
  function TextField(container, data) {
    ...
    this.buildData = function () {
      ...
      if (_this.updated) {
        return Object.assign(Object.assign({}, _this.data), {
